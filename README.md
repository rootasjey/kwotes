<p align="middle">
  <img src="./screenshots/kwotes-banner.jpg" title="kwotes icon" />
</p>
...
| [sliver_tools](https://pub.dev/packages/flex_list)                                   | Puts as many provided elements as possible in one row (like Wrap), but also extends the width of the elements by the remaining space per row.                                                                                                          |
